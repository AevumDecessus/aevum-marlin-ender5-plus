...
// :[-1,1]
// AevumEditExperimental move 0,0 to the lower left instead of rear right, see if it rotates it to what slicers actually use
#define X_HOME_DIR 1
#define Y_HOME_DIR 1
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
 ...
 */
// AevumEdit print counter stats for nerds
#define PRINTCOUNTER
